					...
					<section id="banner">
						<div class="inner">
							...
							<ul class="actions special">
								<li><a href="search.html" class="button primary">Find Games</a></li>
							</ul>
						</div>
					...
					<section id="cta" class="wrapper style4">
						<div class="inner">
							...
							<ul class="actions stacked">
								<li><a href="sign_up.html" class="button fit primary">Sign Up</a></li>
								<li><a href="about_us.html" class="button fit">More About Us</a></li>
							</ul>
						</div>
					</section>
